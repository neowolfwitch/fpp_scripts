 ...
 * playlist_dump.php
 * by Wolf I. Butler
 * v. 2.2, Last Updated: 08/23/2022
 * Updates:
 *  Rsync playlist data to Web server.
 *  Cleaned up code.
 * 
 ...
 * 
 * This should be manually run when the playlist runs (in lead-in).
 * It should not be set up to run automatically!
 * 
 * It may take several minutes to run, depending on the size of the playlist.
 * It intentionally runs slowly, to avoid overtaxing the FPP REST API with metadata requests.
 * 
*/
