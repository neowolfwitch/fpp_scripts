...
$outList = 'Sorted Xmas';              //This is the output playlist name.
...
$reminderList = FALSE;        //Reminder/Welcome playlist. Set to FALSE if not using.
...
//Sort main playlist array...
$arrNew = $json['mainPlaylist'];
sort ( $arrNew, SORT_REGULAR );
